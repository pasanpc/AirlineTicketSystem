...
<body> 
	...
	<form action="FeedbackUpdate" method="post">
		...
		Enter your name :<br> <input type="text" name="userName" required value="<%=fname %>"><br>
		Enter your feedback :<br> <input type="text" name="userFeedback" required value="<%=feedback %>"><br>
